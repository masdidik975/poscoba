...
<div class="row">
    <div class="col-12">
        ...
        <div class="modal fade text-left" id="updatemodal" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
                <div class="modal-content">
                <form class="form form-vertical" method="POST" action="{{url('/update-kategori')}}">  
                    @csrf 
                <div class="modal-header bg-warning">
                                ...
                                <tbody>
                                    @foreach ($kategori as $item)
                                        <tr>
                                            ...
                                            <td><button type="button" class="btn btn-icon rounded-circle btn-success mr-1 mb-1 btn-edit" data-id="{{$item->id_kategori}}" data-kategori="{{$item->nama_kategori}}"><i
                                                class="bx bx-pen"></i></button><a href="{{url('/hapus-kategori/'.$item->id_kategori)}}" type="button" class="btn btn-icon rounded-circle btn-danger mr-1 mb-1" ><i
