...
return [
    'custom' => [
        ...
        'navbarBgColor' => 'bg-warning', //Options:bg-white(default for vertical-menu),bg-primary(default horizontal-menu), bg-success,bg-danger,bg-info,bg-warning,bg-dark.(Note:color only visiable when you scroll down)
